...
export default function EditPackage({ package: pkg, destinations }) {
  const { data, setData, put, errors, processing } = useForm({
    ...
    itinerary: pkg.itinerary || [{ day: '1', title: '', description: '' }],
  ...
  const handleSubmit = (e) => {
    ...
    // Use Inertia's put method instead of router.post
    put(route('admin.packages.update', pkg.id), {
      preserveScroll: true,
      onSuccess: () => {
        // Redirect to packages index after successful update
              ...
              <form onSubmit={handleSubmit} className="space-y-8">
                  ...
                  <div className="mt-1 flex items-center">
                    ...
                    <div>
                      ...
                      <p className="mt-1 text-xs text-gray-500">
                        Leave empty to keep current image. PNG, JPG, GIF up to 2MB
                      </p>
                    </div>
                  </div>
                ...
                <div>
                  ...
                  <div className="space-y-2">
                    {data.available_dates && data.available_dates.map((date, index) => (
